...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'mipres-supplier', loadChildren: 'app/smartity/mipres/mipres.module.ts#MipresModule', canActivate: [PrivilegeGuard] },
      { path: 'mipres-delivery', loadChildren: 'app/smartity/mipres/mipres.module.ts#MipresModule', canActivate: [PrivilegeGuard] },
      { path: 'mipres-admin', loadChildren: 'app/smartity/mipres/mipres.module.ts#MipresModule', canActivate: [PrivilegeGuard] },
