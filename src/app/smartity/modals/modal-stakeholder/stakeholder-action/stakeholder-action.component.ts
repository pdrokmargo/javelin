...
@Component({
    selector: 'stakeholder-action-cmp',
    templateUrl: './stakeholder-action.component.html',
    styles: []
})

export class StakeholderActionComponent extends BaseModel implements OnInit {
